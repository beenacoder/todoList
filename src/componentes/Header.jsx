...
const Header = ({mostrarCompletadas, cambiarMostrarCompletadas}) => {
    ...
    return ( 
        <header className='header'>    
            ...
            {mostrarCompletadas ?
                <button className="header__boton" onClick={() => {toggleCompletadas()}}>No mostrar completadas
                    <FontAwesomeIcon 
                        icon={faEyeSlash} 
            ...
            :
                <button className="header__boton" onClick={() => {toggleCompletadas()}}>Mostrar completadas
                    <FontAwesomeIcon 
                        icon={faEye} 
                        className="header__icono-boton"
